	...
	<div id="redux-footer">
		...
		<div class="redux-action_bar">
			...
			if ( false === $this->parent->args['hide_save'] ) {
				submit_button( esc_html__( 'ذخیره تغییرات', 'redux-framework' ), 'primary', 'redux_save', false, array( 'id' => 'redux_bottom_save' ) );
			}

			if ( false === $this->parent->args['hide_reset'] ) {
				submit_button( esc_html__( 'بازگردانی پیش فرض بخش', 'redux-framework' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section-bottom' ) );
				submit_button( esc_html__( 'بازگردانی پیش فرض همه', 'redux-framework' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults-bottom' ) );
			}
			?>
		</div>
