...
<table class="shop_attributes woocommerce-group-attributes-layout-2">
	...
	<?php if ( $display_dimensions && $product->has_weight() ) : ?>
		<tr class="<?php if ( ( $alt = $alt * -1 ) == 1 ) echo 'alt'; ?>">
			...
			<td colspan="2" class="product_weight"><?php echo esc_html( wc_format_weight( $product->get_weight() ) ); ?></td>
		</tr>
	<?php endif; ?>
	...
	<?php if ( $display_dimensions && $product->has_dimensions() ) : ?>
		<tr class="<?php if ( ( $alt = $alt * -1 ) == 1 ) echo 'alt'; ?>">
			...
			<td colspan="2" class="product_dimensions"><?php echo esc_html( wc_format_dimensions( $product->get_dimensions( false ) ) ); ?></td>
		</tr>
	<?php endif; ?>
