...
<?php if($settings['pagination'] != 'none' && $settings['tabs_filter'] == 'none' && $settings['layout'] == 'grid') : ?>
  ...
  <?php if($zoo_pag_type == 'ajaxload' || $zoo_pag_type == 'infinity'): wp_enqueue_script('infinite-scroll'); ?>
    ...
    <?php endif; ?>
    <?php
    cafe_pagination(3, $product_query, '', '<i class="zoo-icon-long-arrow-left"></i> ' . esc_html__('', 'cafe'), esc_html__('', 'cafe') . ' <i class="zoo-icon-long-arrow-right"></i>');
    ?>
    <?php if($zoo_pag_type == 'ajaxload' || $zoo_pag_type == 'infinity') : ?>

        <div class="scroller-status">
            <div class="infinite-scroll-request">
                <div class="pagination-loading"><span class="loading"><?php echo esc_html__('LOADING...','cafe') ?></span></div>
            </div>
            <p class="infinite-scroll-last"><?php echo esc_html__('All items loaded','cafe'); ?></p>
            <p class="infinite-scroll-error"><?php echo esc_html__('No more page','cafe'); ?></p>
        </div>
        <?php if ($zoo_pag_type == 'ajaxload') { ?>
            <p class="view-more-button"><span><?php echo esc_html__('Load More','cafe') ?></span></p>
        <?php } ?>
    </div>
<?php endif; ?>
<?php endif; ?>
