                        ...
                        <div class="wrap-media">
                            ...
                            if (is_sticky()) {
                                ...
                                <span class="sticky-post-label"><i
                                            class="cs-font clever-icon-light"></i> <?php echo esc_html__('Featured', 'cafe') ?></span>
                                <?php
                            }
                            ?>
                        ...
                        if ($settings['show_read_more'] == 'true') {
                            ...
                            <a href="<?php the_permalink(); ?>"
                               class="readmore"><?php
                                ...
                                echo esc_html__('Read more', 'cafe');
                                ?></a>
                            <?php
                        }
                        ?>
                    ...
                    if ($layout == 'list'):
                        ...
                        <div class="wrap-post-item-content">
                            ...
                            if ($settings['show_read_more'] == 'true') {
                                ?>
                                <a href="<?php the_permalink(); ?>"
                                   class="readmore"><?php echo esc_html__('Read more', 'cafe'); ?></a>
                                <?php
                            }
                            ?>
                        </div>
