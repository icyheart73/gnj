...
if (class_exists('WooCommerce')):
    final class CleverProductDeal extends CleverWidgetBase
    {
        ...
        function get_title()
        {
            return __('Clever Product Deal', 'cafe');
        }
        ...
        protected function _register_controls()
        {
            $this->start_controls_section(
                ...
                $this->add_control('action_title', [
                    'label'         => __('Action title', 'cafe'),
                    'type'          => Controls_Manager::TEXT,
                    'default'       => __( 'Action title', 'cafe' ),
                ]);
                $this->add_control('action_link', [
                    'label'         => __('Action link', 'cafe'),
                    'description'   => __('', 'cafe'),
            ...
            $this->start_controls_section(
                ...
                $this->add_control('layout_style', [
                    ...
                    'options' => [
                        ...
                        'layout-1' => __( 'Layout 1', 'cafe' ),
                        'layout-2' => __( 'Layout 2', 'cafe' ),
                    ],
                ]);
                $this->add_control('date_time', [
                    'label'         => __('Date for sale', 'cafe'),
                    'description'   => __('', 'cafe'),
        ...
        {
            return ['jquery-slick','countdown','cafe-script'];
        }
        /**
         * Render
         */
