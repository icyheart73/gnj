<?php
/**
 * View template for Ganje Banner widget
 *
...
<div class="<?php echo esc_attr($gnje_wrap_class) ?> " data-gnje-config='<?php echo esc_attr($gnje_json_config) ?>'>
   <div class="gnje-row">
    <?php
    $css_class = 'gnje-banner ';
    if ($settings['overlay_banner'] == 'true') {
        $css_class .= $settings['effect'] . ' gnje-overlay-content gnje-col';
    }
