...
$button_class='gnje-button section-item-btn ';
...
?>
<div class="gnje-fullpage-scrolling-wrapper">
    <div class="gnje-fullpage-scrolling-sections">
        <?php echo implode('', $sections); ?>
    </div>
    <?php
    if ($settings['show_navbar']) {
        ?>
        <div class="gnje-fullpage-navbar gnje-fullpage-navbar-<?php echo $settings['navbar_position'] ?>">
            <ul>
            <?php
            foreach ($settings['sections'] as $section) {
