...
$button_class='gnje-button gnje-slide-btn ';
...
<div class="swiper-container ibenzz_slider">
    <div class="swiper-wrapper">
        ...
        if ( ! empty( $slide_url ) ) {
	        ...
	        $output .='<div class="gnje-slide-bg-overlay"></div>';
	        $output .='<div class="gnje-slide-heading">'.$slide['heading'].'<br/>'.$slide['description'];
	        $output .= '</div></div>';
	        $slide_count++;
        }
