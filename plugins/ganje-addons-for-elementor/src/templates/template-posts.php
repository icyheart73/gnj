...
if ($the_query->have_posts()):
    ...
    $css_class = 'gnje-posts';
    $css_class .= ' ' . $layout . '-layout';
    $css_class_item[] = 'gnje-post-item';
    $css_class_item[] = 'post-loop-item';
    $css_class_item[] = $layout . '-layout-item';
    $css_class_item[] = 'gnje-col';
    $data_config = '';
    $gnje_json_config = '';
    if ($layout == 'grid') {
        $css_class .= ' gnje-row gnje-grid-lg-' . $settings['col'] . '-cols gnje-grid-md-' . $settings['col_tablet'] . '-cols gnje-grid-' . $settings['col_mobile'] . '-cols';
    } elseif ($layout == 'carousel') {
        $css_class .= ' gnje-carousel grid-layout';
                        ...
                        <div class="wrap-media">
                            ...
                            if (is_sticky()) {
                                ...
                                <span class="sticky-post-label"><i
                                            class="cs-font ganje-icon-light"></i> <?php echo esc_html__('Featured', 'gnje') ?></span>
                                <?php
                            }
                            ?>
                        ...
                        <ul class="post-info">
                            ...
                            if ($settings['show_author_post'] == 'true') { ?>
                                <li class="author-post">
                                    <i class="cs-font ganje-icon-user-2"></i>
                            ...
                            if ($settings['show_date_post'] == 'true') {
                                ?>
                                <li class="post-date">
                                    <i class="cs-font ganje-icon-clock-4"></i>
                                    <?php
                        ...
                        if ($settings['output_type'] != 'none') { ?>
                            <div class="entry-content">
                                ...
                                if ($settings['output_type'] == 'excerpt') {
                                    echo gnje_get_excerpt($settings['excerpt_length']);
                                } else {
                                    the_content();
                                }
                                ?>
                        ...
                        if ($settings['show_read_more'] == 'true') {
                            ...
                            <a href="<?php the_permalink(); ?>"
                               class="readmore"><?php
                                ...
                                echo esc_html__('Read more', 'gnje');
                                ?></a>
                            <?php
                        }
                        ?>
                    ...
                    if ($layout == 'list'):
                        ...
                        <div class="wrap-post-item-content">
                            ...
                            <ul class="post-info">
                                <?php
                                if ($settings['show_author_post'] == 'true') { ?>
                                    <li class="author-post"><i class="cs-font ganje-icon-user-2"></i>
                                        <a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'), get_the_author_meta('user_nicename'))); ?>"
                                           title="<?php echo esc_attr(get_the_author()) ?>">
                                            <?php echo esc_html(get_the_author()) ?>
                                        </a>
                                ...
                                if ($settings['show_date_post'] == 'true') {
                                    ...
                                    <li class="post-date"><i
                                                class="cs-font ganje-icon-clock-4"></i> <?php echo esc_html(get_the_date()); ?>
                                    </li>
                                <?php }
                                if ($settings['show_cat_post'] == 'true') {
                                    ?>
                                    <li class="list-cat"><i
                                                class="cs-font ganje-icon-document"></i><?php echo get_the_term_list(get_the_ID(), 'category', '', ', ', ''); ?>
                                    </li>
                                <?php }
                                ?>
                            </ul>
                            ...
                            if ($settings['show_read_more'] == 'true') {
                                ?>
                                <a href="<?php the_permalink(); ?>"
                                   class="readmore"><?php echo esc_html__('Read more', 'gnje'); ?></a>
                                <?php
                            }
                            ?>
                        </div>
                                    ...
                                    <a href="<?php the_permalink(); ?>"
                                       class="readmore"><?php
                                        if ($style == 'image-shadow') {
                                            ?>
                                            <i class="cs-font ganje-icon-arrow-bold"></i>
                                            <?php
                                        } else {
                                            echo esc_html__('Read more', 'gnje');
                                        }
