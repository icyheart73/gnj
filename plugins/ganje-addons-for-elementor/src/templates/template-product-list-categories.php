<?php
/**
 * View template for Ganje Product List Categories
 *
...
<div class="<?php echo esc_attr($gnje_wrap_class) ?> " data-gnje-config='<?php echo esc_attr($gnje_json_config) ?>'>
    ...
    <ul class="product-categories gnje-row <?php echo esc_attr($class) ?>">
        <?php 
        if($settings['layout_style'] == 'sub_cate'){
            foreach ($settings['filter_parent_categories'] as $cat) {
                ...
                if(isset($cat_opp->term_id)) {
                    ...
                    if($cat_opp->term_id){
                        echo '<li class="gnje-col category wrap-category-item"><div class="wrap-content-category-item"><div class="category-image">';
                        ...
                        if((int)$settings['max_sub_cat']<(int)count($children)){
                            ?>
                            <a href="<?php echo esc_url($cat_url);?>" class="view-more" title="<?php echo esc_attr($cat_name)?>"><?php echo esc_attr($settings['show_view_more_text'])?> <i class="cs-font ganje-icon-arrow-right"></i> </a>
                            <?php
                        }
                        echo '</div></div></li>';
                    }
